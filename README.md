...
comet tail behind it, over the whole splash duration — arcing clear of the
console block rather than crossing it — while the wordmark itself ignites
left to right on power-up. The duration is configurable — see
